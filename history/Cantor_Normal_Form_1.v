    ...
    + (* α ^ MaxinExp α β ∈ β *)
      ...
      * assert( Second x ≺ β ). eapply Ord_Num_trans; eauto.
        ...
        assert( L2: ∀ a b, a ∈ R -> b = γ \/ b = δ
                -> Function (f' a b) /\ dom(f' a b) = PlusOne dom(γ)
                /\ ran(f' a b) ⊂ R ).
      ...
      rewrite <- H26 in H28,H29. appA2H H29. rdeHex. New H31.
      appoA2H H32. destruct H33. destruct H34; deand. rewrite H34 in H30.
      red in H30. emf. eapply Property_Fun in H31; eauto. rewrite <- H31.
      rewrite H35. clear x0 H31 H32 H35. appA2H H28. rdeHex. New H31.
      ...
      { TF( n = Φ ). subst. right; auto.
        ...
        assert( L: ∀ z, z ∈ ∪ dom(f α γ δ) -> (f α γ δ)[PlusOne z] ∈ R ).
        ...
        { eqext. appA2H H47. rdeHex. appoA2H H48. deand; auto.
          ...
          New H47. apply L in H48. appA2H H48. appA2H H49. rdeHex. appoA2G. }
        assert( Function g ).
        ...
        { red. intros. appA2H H50. rdeHex.
          appoA2H H51. deand. subst. eapply L; eauto. }
...
Unshelve. New Φ_is_Ord. eapply Lem123 in H25. auto. auto.
